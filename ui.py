...
enable_summarization = st.checkbox("Enable web context summarization", value=False, help="Summarize web snippets into themes before generating ideas (may improve quality)")
